...
<x-section-header
    ...
    subtitle="Add a vehicle to your inventory"
/>
...
>
        ...
        <x-slot:header>
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Enter the basic vehicle information
                </p>
            </div>
        </x-slot:header>
            ...
            <div>
                ...
                <select
                    ...
                    class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm
                           text-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                >
    ...
    <x-card>
        ...
        <x-slot:header>
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Purchase price, commission and additional expenses
                </p>
            </div>
        </x-slot:header>
        ...
        {{-- Net Rate --}}
        <div class="mt-6 flex items-center justify-between rounded-lg bg-gray-50 px-5 py-4">
    ...
    <x-card>
        ...
        <x-slot:header>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Add additional expenses related to this vehicle
                    </p>
                </div>
                ...
                <button
                    type="button"
                    @click="addExpense()"
                    class="inline-flex items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium
        ...
        {{-- Expense Header --}}
        <div class="mb-3 hidden grid-cols-12 gap-3 border-b border-gray-100 pb-3 md:grid">
            ...
            <div class="grid grid-cols-1 gap-4 border-b border-gray-100 py-4 md:grid-cols-12 md:items-end">
                ...
                <div class="md:col-span-3">
                    ...
                    <x-input
                        ...
                        type="number"
                        step="0.01"
                        x-bind:name="'expenses['+i+'][percentage]'"
